...
$string['rocketchatname'] = 'Nom du groupe (dans Rocket.Chat)';
...
$string['groupnametoformat_desc'] = 'Le formattage par variable est possible avec l'emploi de {$a->variable}; Les variables utilisables sont les suivantes : moodleid, moodleshortname, moodlefullname, moduleid, modulemoodleid (identifiant unique de la plateforme moodle), courseid, courseshortname, coursefullname';
...
$string['deletionmode'] = 'Mode de suppression des groupes Rocket.Chat';
$string['deletionmode_desc'] = 'Choix de comportement lors de la suppression d\'une instance de module';
$string['deletion_archive'] = 'Archivage du groupe Rocket.Chat';
$string['deletion_hard'] = 'Suppression du groupe Rocket.Chat';
